...
const bg = {
  ...
  home: {
    ...
    heroText: "Качи снимка и след минута виж любим човек като истинска фигурка.",
    heroSticker: "Виж я за 1 минута",
    heroSecondary: "Виж примери",
  ...
  studio: {
    ...
    pick: "Избери снимка",
    formats: "Всякакъв формат — JPG, PNG, HEIC от iPhone и др.",
    converting: "Подготвяме снимката…",
    ...
    addedShort: "Добавено ✓",
    badType: "Не успяхме да отворим тази снимка. Опитай с друга или със скрийншот от нея.",
    tooBig: "Файлът е над 50 MB. Избери по-малка снимка.",
...
const en: Dict = {
  ...
  home: {
    ...
    heroText: "Upload a photo and see someone you love as a real figurine in a minute.",
    heroSticker: "See it in 1 minute",
  ...
  studio: {
    ...
    pick: "Choose a photo",
    formats: "Any format — JPG, PNG, HEIC from iPhone and more",
    converting: "Preparing your photo…",
    change: "Change photo",
    ...
    addedShort: "Added ✓",
    badType: "We couldn't open this photo. Try another one or a screenshot of it.",
    tooBig: "The file is over 50 MB. Choose a smaller photo.",
