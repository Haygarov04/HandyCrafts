...
const portfolioItems = [
  ...
  { title: "Фигура", category: "3D Принтиране", image: "/portfolio/p3.DNG" },
  { title: "Персонализиран модел", category: "3D Моделиране", image: "/portfolio/p4.DNG" },
  { title: "Функционален компонент", category: "3D Принтиране", image: "/portfolio/p5.DNG" },
  { title: "Малък custom детайл", category: "Custom", image: "/portfolio/p6.DNG" },
  { title: "Брандиран елемент", category: "3D Принтиране", image: "/portfolio/p7.DNG" },
  { title: "Техническа част", category: "3D Моделиране", image: "/portfolio/p8.DNG" },
  { title: "Прототип", category: "3D Принтиране", image: "/portfolio/p9.DNG" },
  { title: "Мини проект", category: "Custom", image: "/portfolio/p10.DNG" },
  { title: "Декоративен модел", category: "3D Принтиране", image: "/portfolio/p11.DNG" },
  { title: "Комплект части", category: "3D Моделиране", image: "/portfolio/p12.DNG" },
  { title: "Книжен аксесоар", category: "Custom", image: "/portfolio/p13.DNG" },
  { title: "CAD подготовка", category: "3D Моделиране", image: "/portfolio/p14.DNG" },
  { title: "Практичен детайл", category: "3D Принтиране", image: "/portfolio/p15.DNG" },
  { title: "Серия изделия", category: "3D Принтиране", image: "/portfolio/p16.DNG" },
  { title: "Малки елементи", category: "3D Принтиране", image: "/portfolio/p17.JPG" },
  { title: "Компонент в ръка", category: "Custom", image: "/portfolio/p18.DNG" },
  ...
  { title: "Резбован модел", category: "3D Моделиране", image: "/portfolio/p26.DNG" },
  { title: "Функционална геометрия", category: "3D Принтиране", image: "/portfolio/p27.DNG" },
  { title: "Реален процес", category: "3D Принтиране", image: "/portfolio/p28.PNG" },
  { title: "Сферичен елемент", category: "3D Принтиране", image: "/portfolio/p29.DNG" },
  { title: "Технически корпус", category: "3D Моделиране", image: "/portfolio/p30.PNG" },
...
function PortfolioCard({
  ...
  return (
    <div className="group relative h-[320px] min-w-[280px] overflow-hidden rounded-[28px] bg-neutral-200 shadow-[0_20px_60px_rgba(0,0,0,0.08)] md:min-w-[360px]">
      <Image
        src={image}
        alt={title}
        fill
    ...
    <div className="grid gap-10 xl:grid-cols-[1.05fr_0.95fr] xl:items-start">
      ...
      <div className="xl:pt-4">
        <p className="mb-6 text-lg leading-8 text-neutral-700 md:text-xl">
          Smart Shift Knob е концептуален и функционален automotive проект за
          умен скоростен лост с интегриран кръгъл дисплей, custom корпус и
          собствен интерфейс, създаден за интерактивно управление в автомобила.
          Проектът комбинира индустриален дизайн, 3D моделиране, 3D принтиране,
          хардуерна интеграция и UI/UX разработка в един завършен premium
          prototype.
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-[24px] border border-black/5 bg-neutral-50 p-5">
            ...
            <p className="leading-7 text-neutral-700">
              3D моделиране, 3D принтиране, продуктов дизайн, прототипиране и
              UI/UX разработка.
            </p>
          </div>
          ...
          <div className="rounded-[24px] border border-black/5 bg-neutral-50 p-5">
            ...
            <p className="leading-7 text-neutral-700">
              Корпус с M12 монтажна резба, интегриран дисплей модул и вътрешно
              пространство за електроника и захранване.
            </p>
          </div>
          ...
          <div className="rounded-[24px] border border-black/5 bg-neutral-50 p-5">
            ...
            <p className="leading-7 text-neutral-700">
              Music control, gear indicator, speed display, 0–100 / 0–60 timer,
              themes и персонализация.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 space-y-5">
          <p className="leading-8 text-neutral-700">
            Софтуерната концепция е изградена около Apple Watch–style home menu
            с бърза навигация чрез swipe жестове и tap взаимодействия. Системата
            включва приложения за музикален контрол, индикация на предавка,
            визуализация на скорост, таймер за ускорение, lock screen, startup
            animation и централизирани настройки.
          </p>
          ...
          <p className="leading-8 text-neutral-700">
            ...
            който превръща стандартния скоростен лост в интелигентен и визуално
            отличим продукт за модерния автомобилен интериор.
          </p>
        </div>
      </div>
    </div>
