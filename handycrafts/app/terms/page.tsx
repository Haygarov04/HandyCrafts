...
const sections = [
  ...
  {
    title: "10. Поръчка на фигурки и ключодържатели",
    text: "Цените на фигурките и ключодържателите са посочени в сайта в евро с включен ДДС, ако е приложимо. Плащането е с наложен платеж при получаване на пратката, а доставката се заплаща по тарифа на куриера. Всяка поръчка се потвърждава по телефона преди изработка. Визуализацията е ориентировъчна и показва стила, позата и дрехите; готовото изделие се изработва на ръка и може да има малки разлики в детайлите.",
  },
  {
    title: "11. Право на отказ",
    text: "Фигурките и ключодържателите се изработват по снимка и указания на клиента и са ясно персонализирани. Съгласно чл. 57, т. 3 от Закона за защита на потребителите за тях не се прилага правото на отказ в 14-дневен срок. Ако пратката пристигне повредена, свържи се с нас до 48 часа от получаването със снимки и ще я изработим отново.",
  },
  {
    title: "12. Снимки и лични данни",
    text: "Качените снимки се използват само за визуализацията и изработката на поръчката, съхраняват се в затворено хранилище и не се публикуват без изрично съгласие. Клиентът декларира, че има право да използва снимката и съгласието на човека на нея. Може да поискаш изтриване на снимките по имейл.",
  },
  {
    title: "13. Промени",
