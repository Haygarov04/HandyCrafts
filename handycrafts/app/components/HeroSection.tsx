...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center px-4 pt-28 sm:px-6">
        <div className="max-w-3xl text-white">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.25em] text-orange-400 sm:text-sm sm:tracking-[0.3em]">
          ...
          <p className="mb-8 max-w-2xl text-base leading-7 text-white/85 sm:text-lg sm:leading-8">
