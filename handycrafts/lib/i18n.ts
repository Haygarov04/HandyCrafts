...
const bg = {
  ...
  home: {
    heroTitle: ["3D фигурки", "по снимка."],
    heroText: "Персонализирани фигурки и ключодържатели по твоя снимка. Оригинален подарък за рожден ден, годишнина или любим човек.",
    create: "Създай фигурка",
    pricesFrom: "Цени от",
    ...
    productsTitle: ["Твоят спомен.", "Твоята форма."],
    productsText: "Избери как да го запазиш.",
    products: [
      ...
      { title: "Ключодържатели", text: "Винаги с теб. Човек или любимец, в джоба." },
    ],
    sizeTitle: "Колко голяма е?",
    sizeKeychain: "ключодържател",
    sizeFigurine: "фигурка",
    howTitle: ["Всичко започва", "с една снимка."],
    processAlt: "Снимка на човек и готовата му фигурка една до друга",
    steps: [
      { title: "Качи снимка", text: "Една ясна снимка на човека или любимеца." },
      { title: "Виж фигурката", text: "Визуализация за минута. Одобряваш, преди да поръчаш." },
      { title: "Получи своето мини", text: "Изработваме я на ръка и я пращаме с куриер." },
    ],
    ...
    giftKicker: "Малък подарък. Голяма реакция. ♡",
    giftTitle: ["Следващата фигурка", "е твоята."],
    occasions: ["Рожден ден", "Годишнина", "Сватба", "Свети Валентин", "Коледа", "Абитуриент", "За колега", "За баба и дядо"],
    giftButton: "Създай своето мини",
...
const en: Dict = {
  ...
  home: {
    heroTitle: ["3D figurines", "from a photo."],
    heroText: "Custom figurines and keychains made from your photo. A one-of-a-kind gift for a birthday, an anniversary or someone you love.",
    create: "Create a figurine",
    ...
    productsTitle: ["Your memory.", "Your shape."],
    productsText: "Choose how to keep it.",
    products: [
      ...
      { title: "Keychains", text: "Always with you. A person or a pet, in your pocket." },
    ],
    sizeTitle: "How big is it?",
    sizeKeychain: "keychain",
    sizeFigurine: "figurine",
    howTitle: ["It all starts", "with one photo."],
    processAlt: "Photo of a man next to his finished figurine",
    steps: [
      { title: "Upload a photo", text: "One clear photo of the person or pet." },
      { title: "See the figurine", text: "A preview in a minute. Approve it before you order." },
      { title: "Get your mini", text: "We finish it by hand and ship it by courier." },
    ],
